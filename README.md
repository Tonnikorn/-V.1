  ...
  <div class="wrap" role="application">
    <header>
      <div class="brand">
        ...
        <div>
          <h1>CoupleSplit</h1>
          <p class="lead">โปรแกรมคำนวณค่าใช้จ่ายของต้นและป๋อมแป๋ม</p>
        </div>
      </div>
    ...
    <main>
      ...
      <aside class="right-col">
        ...
        <div class="panel">
          ...
          <div style="margin-top:10px" class="muted">เมนูเพิ่มเติม: ส่งบิล</div>
        </div>
      </aside>
    </main>

    <footer>
      <div>คิดค้นและพัฒนาโดย Tonix Version1.2.2.221</div>
